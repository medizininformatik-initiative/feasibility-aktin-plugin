...
public record FhirConnector(IGenericClient client) {
   ...
   * @throws IOException if the communication with the FHIR server fails due to
  ...
  public void transmitBundle(Bundle bundle) throws IOException {
    try {
      ...
      throw new IOException(
          "An error occurred while trying to create measure and library", e);
    }
  }
  ...
  public MeasureReport evaluateMeasure(String measureUri) throws IOException {
    try {
      return client.operation()
          ...
          .withSearchParameter(Parameters.class, "measure",
      ...
      throw new IOException(
          "An error occurred while trying to evaluate a measure report", e);
    }
  }
